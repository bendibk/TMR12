...
def main():
    ...
    # -----------------------------
    t0 = pd.Timestamp("2025-07-12 05:30", tz="UTC")
    t1 = pd.Timestamp("2025-07-12 06:30", tz="UTC")
    ...
    # Axis 1 (left): RPM
    l1, = ax1.plot(dfw["timestamp"], dfw["ShaftRev_rpm"], lw=2, color=c_rpm, label="ShaftRev_rpm")
    ax1.set_ylabel("Shaft RPM [rpm]", color=c_rpm, fontsize=LABEL_FS)
    ...
    ax1.legend(lines, labels, loc="upper left", fontsize=LEGEND_FS)
